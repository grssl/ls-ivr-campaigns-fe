...
export default function DashboardTotalCount({AdminDashboardDatList}) {
    ...
    return (
        <>
            <h3 className="text-center font-bold text-xl uppercase bg-orange-200 p-2 "> Total campaign Report </h3>
